...
let
  ...
  sparkle-service = buildGoModule {
    ...
    src = fetchFromGitHub {
      ...
      rev = "30a4df5761f995119cc885b48d711153a6284098";
      hash = "sha256-UmEkkx0uyB0ROa6fkLj4piXoUzAsH899FnOi7Xg7hAM=";
    };

    vendorHash = "sha256-zwDe1/uGTeQ0lnskmbVGsAD1cZbUNqkFAcesdCw3w1c=";
